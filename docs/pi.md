...
Pi Integration Architecture covers an important aspect of the MagicMerlin ecosystem. This page
provides reference information, configuration guidance, and usage examples.

## Details

Pi Integration Architecture integrates with the MagicMerlin gateway and agent runtime to provide
