...
Gmail PubSub enables automated workflows in MagicMerlin. Automation features allow
...
### Configure Gmail PubSub

```bash
magicmerlin cron add --schedule "*/5 * * * *" --action "gmail-pubsub"
```
