...
Automation Troubleshooting enables automated workflows in MagicMerlin. Automation features allow
...
### Configure Automation Troubleshooting

```bash
magicmerlin cron add --schedule "*/5 * * * *" --action "troubleshooting"
```
