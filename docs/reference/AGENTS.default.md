...
Default AGENTS.md provides detailed reference information for MagicMerlin internals,
configuration options, and operational procedures.

## Details

This reference document covers the specifics of default agents.md as implemented
