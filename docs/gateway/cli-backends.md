...
CLI Backends covers an essential aspect of the MagicMerlin gateway. The gateway
...
Settings related to cli backends can be adjusted there.

```toml
[gateway]
# CLI Backends settings
enabled = true
```
...
If you encounter issues with cli backends:
