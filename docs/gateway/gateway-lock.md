...
Gateway Lock covers an essential aspect of the MagicMerlin gateway. The gateway
...
Settings related to gateway lock can be adjusted there.

```toml
[gateway]
# Gateway Lock settings
enabled = true
```
...
If you encounter issues with gateway lock:
