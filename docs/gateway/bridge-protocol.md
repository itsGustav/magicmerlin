...
Bridge Protocol covers an essential aspect of the MagicMerlin gateway. The gateway
...
Settings related to bridge protocol can be adjusted there.
...
```json
{
  "method": "gateway.bridge-protocol",
  "params": {}
}
```
...
If you encounter issues with bridge protocol:
