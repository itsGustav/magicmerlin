...
Doctor covers an essential aspect of the MagicMerlin gateway. The gateway
...
Settings related to doctor can be adjusted there.
...
If you encounter issues with doctor:
