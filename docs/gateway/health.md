...
Health Checks covers an essential aspect of the MagicMerlin gateway. The gateway
...
Settings related to health checks can be adjusted there.
...
If you encounter issues with health checks:
