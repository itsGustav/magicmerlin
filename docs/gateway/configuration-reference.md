...
Configuration Reference covers an essential aspect of the MagicMerlin gateway. The gateway
...
Settings related to configuration reference can be adjusted there.
...
```json
{
  "method": "gateway.configuration-reference",
  "params": {}
}
```
...
If you encounter issues with configuration reference:
