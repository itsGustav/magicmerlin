...
Channel Location Parsing is a supported messaging channel in MagicMerlin. Channels allow your
...
- Valid credentials for Channel Location Parsing
...
```bash
magicmerlin channels pair location
```
