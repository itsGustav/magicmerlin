...
Group Messages is a supported messaging channel in MagicMerlin. Channels allow your
...
- Valid credentials for Group Messages
...
```bash
magicmerlin channels pair group-messages
```
