...
Channel Routing is a supported messaging channel in MagicMerlin. Channels allow your
...
- Valid credentials for Channel Routing
...
```bash
magicmerlin channels pair channel-routing
```
