...
Synology Chat is a supported messaging channel in MagicMerlin. Channels allow your
...
- Valid credentials for Synology Chat
...
```bash
magicmerlin channels pair synology-chat
```
