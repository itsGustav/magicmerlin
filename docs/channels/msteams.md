...
Microsoft Teams is a supported messaging channel in MagicMerlin. Channels allow your
...
- Valid credentials for Microsoft Teams
...
```bash
magicmerlin channels pair msteams
```
