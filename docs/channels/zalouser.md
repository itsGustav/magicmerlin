...
Zalo Personal is a supported messaging channel in MagicMerlin. Channels allow your
...
- Valid credentials for Zalo Personal
...
```bash
magicmerlin channels pair zalouser
```
