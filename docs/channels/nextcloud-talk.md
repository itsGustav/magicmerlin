...
Nextcloud Talk is a supported messaging channel in MagicMerlin. Channels allow your
...
- Valid credentials for Nextcloud Talk
...
```bash
magicmerlin channels pair nextcloud-talk
```
