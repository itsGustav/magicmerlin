...
Channel Troubleshooting is a supported messaging channel in MagicMerlin. Channels allow your
...
- Valid credentials for Channel Troubleshooting
...
```bash
magicmerlin channels pair troubleshooting
```
