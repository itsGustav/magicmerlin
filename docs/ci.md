...
CI Pipeline covers an important aspect of the MagicMerlin ecosystem. This page
provides reference information, configuration guidance, and usage examples.

## Details

CI Pipeline integrates with the MagicMerlin gateway and agent runtime to provide
